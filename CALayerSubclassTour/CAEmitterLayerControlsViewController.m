...
- (void)viewDidLoad
{
  ...
  self.emitterLayerRenderModes = @[kCAEmitterLayerUnordered, kCAEmitterLayerOldestFirst,
    kCAEmitterLayerOldestLast, kCAEmitterLayerBackToFront, kCAEmitterLayerAdditive];
...
- (IBAction)sliderChanged:(UISlider *)sender
{
  ...
  switch (index) {
    case SliderEmitterCellColor: keyPath = @"emitterCell.color"; break;
    case SliderEmitterCellRedRange: keyPath = @"emitterCell.redRange"; break;
    case SliderEmitterCellGreenRange: keyPath = @"emitterCell.greenRange"; break;
    case SliderEmitterCellBlueRange: keyPath = @"emitterCell.blueRange"; break;
    case SliderEmitterCellAlphaRange: keyPath = @"emitterCell.alphaRange"; break;
    case SliderEmitterCellRedSpeed: keyPath = @"emitterCell.redSpeed"; break;
    case SliderEmitterCellGreenSpeed: keyPath = @"emitterCell.greenSpeed"; break;
    case SliderEmitterCellBlueSpeed: keyPath = @"emitterCell.blueSpeed"; break;
    case SliderEmitterCellAlphaSpeed: keyPath = @"emitterCell.alphaSpeed"; break;
    case SliderEmitterCellScale: keyPath = @"emitterCell.scale"; break;
    case SliderEmitterCellScaleRange: keyPath = @"emitterCell.scaleRange"; break;
    case SliderEmitterCellSpin: keyPath = @"emitterCell.spin"; break;
    case SliderEmitterCellSpinRange: keyPath = @"emitterCell.spinRange"; break;
    case SliderEmitterCellEmissionLatitude: keyPath = @"emitterCell.emissionLatitude"; break;
    case SliderEmitterCellEmissionLongitude: keyPath = @"emitterCell.emissionLongitude"; break;
    case SliderEmitterCellEmissionRange: keyPath = @"emitterCell.emissionRange"; break;
    case SliderEmitterCellLifetime: keyPath = @"emitterCell.lifetime"; break;
    case SliderEmitterCellLifetimeRange: keyPath = @"emitterCell.lifetimeRange"; break;
    case SliderEmitterCellBirthRate: keyPath = @"emitterCell.birthRate"; break;
    case SliderEmitterCellVelocity: keyPath = @"emitterCell.velocity"; break;
    case SliderEmitterCellVelocityRange: keyPath = @"emitterCell.velocityRange"; break;
    case SliderEmitterCellXAcceleration: keyPath = @"emitterCell.xAcceleration"; break;
    case SliderEmitterCellYAcceleration: keyPath = @"emitterCell.yAcceleration"; break;
    case SliderEnd: break;
  }
