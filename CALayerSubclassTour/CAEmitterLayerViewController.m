...
- (CAEmitterLayer *)emitterLayer
{
  if (!_emitterLayer) {
    ...
    _emitterLayer.emitterPosition = (CGPoint){CGRectGetWidth(_emitterLayer.frame) / Two,
      CGRectGetHeight(_emitterLayer.frame) / Two};
//    _emitterLayer.emitterShape = kCAEmitterLayerPoint;
//    _emitterLayer.emitterZPosition = Zero;
//    _emitterLayer.emitterDepth = Zero;
//    _emitterLayer.emitterSize = CGSizeZero;
//    _emitterLayer.scale = One;
//    _emitterLayer.spin = One;
//    _emitterLayer.velocity = One;
//    _emitterLayer.emitterMode = kCAEmitterLayerVolume;
//    _emitterLayer.lifetime = One;
...
- (CAEmitterCell *)emitterCell
{
  if (!_emitterCell) {
      ...
      _emitterCell.contents = (__bridge id)[UIImage imageNamed:@"star"].CGImage;
...
//      _emitterCell.minificationFilterBias = Zero;
...
//      _emitterCell.zAcceleration = Zero;
  }
